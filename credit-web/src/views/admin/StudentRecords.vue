<template>
  <div>
    ...
    <el-card shadow="never" class="animate-in animate-in-delay-1">
      ...
      <el-table :data="pagedStudents" stripe v-loading="loading" style="width: 100%">
        ...
        <el-table-column label="操作" width="120" align="center" fixed="right">
          <template #default="{ row }">
            <button type="button" class="action-btn action-view" @click="handleViewDetail(row)">
